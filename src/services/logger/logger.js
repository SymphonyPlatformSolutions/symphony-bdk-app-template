...
import { setupURL } from '../../utils/setup-url';
import envs from '../../utils/envs-constants';
...
const TITLE_PRIMARY = 'color: #263d5d';
const TITLE_SECONDARY = 'color: #1e304a';
...
// Singleton instance, only to be referred by the static "instance" call
